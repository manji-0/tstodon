...
| Accounts, statuses, follows, outbox rows | D1 (see [D1 writes](./d1-writes.md); ADRs: [json_each](./adr-json-each-membership.md), [TypedSQL exec](./adr-typedsql-d1-execution.md), [migrations](./adr-wrangler-migrations-sot.md), [timeline SQL](./adr-variable-timeline-sql.md)) |
| Media blobs                              | R2                                                                                                                                                                                                                                      |
