 ...
 * @param id
 */
export const findMediaById = $runtime.makeTypedQueryFactory("SELECT id, account_id, status_id, object_key, content_type, created_at,\nCOALESCE(description, '') AS description, focus_x, focus_y,\npreview_object_key, COALESCE(meta_json, '{}') AS meta_json, blurhash,\nCOALESCE(is_private, 1) AS is_private\nFROM media_attachments\nWHERE id = $1") as (id: string) => $runtime.TypedSql<findMediaById.Parameters, findMediaById.Result>
