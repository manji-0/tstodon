 ...
 * @param limit
 */
export const listPublicRemoteStatuses = $runtime.makeTypedQueryFactory(
  "SELECT id, actor_uri, object_uri, url, content_html, spoiler_text, visibility, sensitive, language, published_at\nFROM remote_statuses\nWHERE visibility = 'public'\nORDER BY published_at DESC LIMIT $1",
) as (
  limit: number,
) => $runtime.TypedSql<listPublicRemoteStatuses.Parameters, listPublicRemoteStatuses.Result>;
