 ...
 */
export const listListsContainingAccount = $runtime.makeTypedQueryFactory(
...
) => $runtime.TypedSql<listListsContainingAccount.Parameters, listListsContainingAccount.Result>;
