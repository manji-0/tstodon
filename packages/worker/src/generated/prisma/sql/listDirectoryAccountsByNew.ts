 ...
 * @param offset
 */
export const listDirectoryAccountsByNew = $runtime.makeTypedQueryFactory(
  ...
  limit: number,
  offset: number,
) => $runtime.TypedSql<listDirectoryAccountsByNew.Parameters, listDirectoryAccountsByNew.Result>;
